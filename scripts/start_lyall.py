...
if __name__ == "__main__":
    ...
    folder_name  = '2024_09_04__12-21-38' # folder where this should be saved
    mp4_filepath = '2024_09_04__12-21-38.mp4' # file name of the video file  you want to analyse
